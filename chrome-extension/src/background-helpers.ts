...
export const ALLOWED_ACTIONS = new Set([
  ...
  "GENERATE_AI_CONTENT",
  "FETCH_IMAGES_AS_BLOBS",
  "DEBUGGER_UPLOAD_IMAGES",
  "GET_CURRENT_TAB_ID",
  "AI_AUTO_REPLY",
  ...
  "AI_SETTINGS_SAVE",
  "AI_SETTINGS_TEST",
  "FB_REPLIES_SETTINGS_GET",
  "FB_REPLIES_INGEST_THREAD",
  "FB_REPLIES_INGEST_MESSAGE",
  "FB_REPLIES_INGEST_AUDIT",
  "FB_REPLIES_INGEST_MAPPING",
]);
