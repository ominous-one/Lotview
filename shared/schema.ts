import { pgTable, text, integer, serial, timestamp, boolean, uuid, real, jsonb, customType, index } from "drizzle-orm/pg-core";
...
export const vehicles = pgTable("vehicles", {
  ...
  carfaxConfidenceScore: integer("carfax_confidence_score").default(0), // 0-100 confidence in Carfax data
  carfaxLastUpdated: timestamp("carfax_last_updated"), // When Carfax was last refreshed
